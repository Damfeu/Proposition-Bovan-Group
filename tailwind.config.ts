  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'gradient-hero': 'linear-gradient(135deg, #f5f5f5 0%, #ffffff 50%, #f8f8f8 100%)',
      },
      borderRadius: {
        lg: 'var(--radius)',
      ...
      keyframes: {
        ...
        'glow-pulse': {
          '0%, 100%': { 
            boxShadow: '0 0 5px rgba(227, 6, 19, 0.5), 0 0 10px rgba(227, 6, 19, 0.3)' 
          },
          '50%': { 
            boxShadow: '0 0 20px rgba(227, 6, 19, 0.8), 0 0 30px rgba(227, 6, 19, 0.6)' 
          },
        },
        'shimmer': {
      ...
      boxShadow: {
        ...
        'glow-lg': '0 0 40px rgba(227, 6, 19, 0.4)',
        'inner-glow': 'inset 0 0 20px rgba(227, 6, 19, 0.1)',
